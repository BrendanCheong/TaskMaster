                ...
                <div className="px-4 py-2 md:grid md:grid-cols-3 md:items-center md:pt-5 md:px-6 font-roboto">
                    <div className="mt-1 md:mt-0 md:col-span-3">
                        <div className="grid grid-cols-3 gap-3">
                            <button type="button" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white transition duration-300 bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Show all
                            </button>
                            <button type="button" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium transition duration-300 bg-white border rounded-md shadow-sm hover:bg-zinc-100 border-300 hover:bg-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Show In Progress
                            </button>
                            <button type="button" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium transition duration-300 bg-white border rounded-md shadow-sm hover:bg-zinc-100 border-300 hover:bg-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Show Completed
